    ...
    try:
        ...
        # Handle file upload
            ...
            try:
                ...
                return jsonify({'error': f'Failed to read image file: {str(file_error)}'}), 400
        else:
        ...
        try:
            ...
            print(f"Error detecting faces: {str(detect_error)}")
            return jsonify({'error': f'Face detection failed: {str(detect_error)}'}), 500
        ...
        for face in faces:
            try:
                ...
                print(f"Error processing face data: {str(face_error)}, face: {face}")
                continue
        ...
        print(f"Unexpected error in detect_face: {str(e)}")
        import traceback
        traceback.print_exc()
